...
data Event = Attacked Mob Mob Int | Missed Mob Mob | Died Mob | EndOfTurn | Moved Mob Point | StairsTaken VerticalDirection | Waken Mob | Slept Mob | Inventory InventoryAction | UIClosed deriving Eq

data InventoryAction = ViewInventory deriving Eq
